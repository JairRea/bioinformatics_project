...
from pima_preprocessing import get_pima_preprocessed_data
...
def train_all_models(X_train, X_test, y_train, y_test, feature_names, 
                     save_path_models='models/pima_diabetes/',
...
def generate_visualizations(results, y_test, save_path='results/pima_diabetes/'):
...
def compare_models(results):
    ...
    summary_df = create_summary_table(metrics_data, save_path='results/pima_diabetes/')
...
def main():
    print("\n" + "="*80)
    print(" PIMA DIABETES PREDICTION USING MACHINE LEARNING ".center(80, "="))
    print("="*80)
    ...
    try:
        ...
        print(f"\n{e}")
        print("\nPlease ensure the Pima Diabetes dataset is in the 'data/' folder as 'pima_diabetes.csv'")
        return
    ...
    generate_visualizations(results, y_test, save_path='results/pima_diabetes/')
    ...
    print("Results and visualizations have been saved to the 'results/pima_diabetes/' folder.")
    print("Trained models have been saved to the 'models/pima_diabetes/' folder.")
